...
public class CambiaEstadoAnuncioActivity extends AsyncTask {
    ...
    public CambiaEstadoAnuncioActivity(VerSolicitudesFragment context, Activity activity, String email, String estado) {
