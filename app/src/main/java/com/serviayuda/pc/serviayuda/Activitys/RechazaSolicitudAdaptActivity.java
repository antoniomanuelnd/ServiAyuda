...
public class RechazaSolicitudAdaptActivity extends AsyncTask {
    ...
    public RechazaSolicitudAdaptActivity(SolicitudesFragmentAdapt context, Activity activity, Solicitud solicitud) {
