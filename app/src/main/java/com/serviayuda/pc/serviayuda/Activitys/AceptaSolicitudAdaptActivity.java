...
public class AceptaSolicitudAdaptActivity extends AsyncTask {
    ...
    public AceptaSolicitudAdaptActivity(SolicitudesFragmentAdapt context, Activity activity, Solicitud solicitud) {
